...
pa <- pa %>% 
  mutate(
    ch77_wash_workers = ifelse(colony_num %in% missed, 359, ch77_wash_workers),
    ch77_wash_drones = ifelse(colony_num %in% missed, 4, ch77_wash_drones),
    ch77_wash_queens = ifelse(colony_num %in% missed, 0, ch77_wash_queens),
    )
