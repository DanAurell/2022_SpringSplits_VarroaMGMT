...
It is possible that treatments could increase the length of brood break.
- I could statistically analyze this.
- Referring to the first graph option, some of the right-most colonies with the longest brood breaks... those are probably colonies whose queen cell didn't take and actually a queen from an emergency cell established. There may be an opportunity to highlight this by adding another dashed line

Eventually, see if efficacy of treatment increases with the length of brood break - I would expect this relationship to differ by treatment.
