...
ggsave("./outputs/supp_varroa_daily 2024-03-27.png", width = 12, height = 8.625, units = "in")
```
...
my_conn <- file("./outputs/SuppTable3_2024-03-27.RTF", "w")
...
my_conn <- file("./outputs/SuppTable1_2024-03-21.RTF", "w")
...
my_conn <- file("./outputs/SuppTable2_2024-03-21.RTF", "w")
...
pred %>% 
  ...
  scale_colour_manual(
  limits = c("Control", "OA Vapor", "HopGuard", "Apivar", "OA Dribble", "5x OA Dribble", "Amitraz EC"),
  labels = c("Control", "OA Vapor", "HopGuard", "Apivar", "OA Dribble", "5x OA Dribble", "Amitraz EC"),
...
paneA <- pred %>% 
  ...
  limits = c("Control", "OA Vapor","Apivar", "HopGuard", "OA Dribble", "5x OA Dribble", "Amitraz EC"),
  labels = c("Control", "OA Vapor","Apivar", "HopGuard", "OA Dribble", "5x OA Dribble", "Amitraz EC"),
  aesthetics = "color",
  direction = -1) +
...
# ggsave("./outputs/varroa_pred_2024-03-11 v2-viridis.png", width = 12, height = 8.625, units = "in")
...
ggsave("outputs/combo_var_efficacy 2024-03-21 v1.png", width = 17.25, height = 8, units = "in")
```
...
```{r}
eff77_3b %>% 
  select(trt_label, efficacy, efficacy_LCL, efficacy_UCL)
