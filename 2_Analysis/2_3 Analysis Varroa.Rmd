...
paneA <- pred %>% 
  ...
  limits = c("Control", "OA Vapor","Apivar", "HopGuard", "OA Dribble", "5x OA Dribble", "Amitraz E.C."),
  labels = c("Control", "OA Vapor","Apivar", "HopGuard", "OA Dribble", "5x OA Dribble", "Amitraz E.C."),
  aesthetics = "color",
  direction = -1) +
